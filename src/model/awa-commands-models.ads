...
private
   ...
   package File_1 is
      new ADO.Queries.Loaders.File (Path => "command-permissions.xml",
                                    Sha1 => "9B2B599473F75F92CB5AB5045675E4CCEF926543");

   package Def_Command_User_Permissions is
      new ADO.Queries.Loaders.Query (Name => "command-user-permissions",
