...
package AWA.Storages.Models is
   ...
   --  Set the storage specific data
   procedure Set_Data (Object : in out Storage_Ref;
                       Value  : in Ada.Strings.Unbounded.Unbounded_String);
   procedure Set_Data (Object : in out Storage_Ref;
                       Value : in String);

   --  Get the storage specific data
...
private
   ...
   COL_4_2_NAME : aliased constant String := "data";
   ...
   COL_4_3_NAME : aliased constant String := "name";
   COL_5_3_NAME : aliased constant String := "storage_id";
   STORE_LOCAL_TABLE : aliased constant ADO.Schemas.Class_Mapping :=
     (Count => 6,
