...
package body AWA.Events.Models is
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 14, Impl.User, Value);
   end Set_User;
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 15, Impl.Session, Value);
   end Set_Session;
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 16, Impl.Queue, Value);
   end Set_Queue;
   ...
   begin
      ...
      if Object.Is_Modified (14) then
         Stmt.Save_Field (Name  => COL_13_3_NAME, --  user_id
                          Value => Object.User);
         Object.Clear_Modified (14);
      end if;
      if Object.Is_Modified (15) then
         Stmt.Save_Field (Name  => COL_14_3_NAME, --  session_id
   ...
   begin
      ...
      if not Stmt.Is_Null (14) then
         Object.Session.Set_Key_Value (Stmt.Get_Identifier (14), Session);
      end if;
