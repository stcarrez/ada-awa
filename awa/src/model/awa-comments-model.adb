...
package body AWA.Comments.model is
   ...
   procedure Set_User (Object : in out Comment_Ref;
                        Value  : in AWA.Users.Model.User_Ref'Class) is
      Impl : Comment_Access;
   begin
      Set_Field (Object, Impl, 6);
      Impl.User := AWA.Users.Model.User_Ref (Value);
   end Set_User;
   function Get_User (Object : in Comment_Ref)
                  return AWA.Users.Model.User_Ref'Class is
      Impl : constant Comment_Access := Comment_Impl (Object.Get_Load_Object.all)'Access;
   begin
      return Impl.User;
   end Get_User;
   ...
   procedure List (Object  : in out Comment_Info_Vector;
      ...
      begin
         ...
         Into.Description := Stmt.Get_Unbounded_String (2);
         Into.Promotioncode := Stmt.Get_Unbounded_String (3);
         Into.Free := Stmt.Get_Boolean (4);
      end Read;
   begin
      Stmt.Execute;
