-----------------------------------------------------------------------
--  AWA.Users.Model -- AWA.Users.Model
-----------------------------------------------------------------------
--  File generated by ada-gen DO NOT MODIFY
--  Template used: templates/model/package-body.xhtml
--  Ada Generator: https://ada-gen.googlecode.com/svn/trunk Revision 71
-----------------------------------------------------------------------
...
package body AWA.Users.Model is
   ...
   begin
      ...
      Impl := Email_Impl (Object.Get_Object.all)'Access;
   end Set_Field;
   ...
   procedure Save (Object  : in out Email_Impl;
                   Session : in out ADO.Sessions.Master_Session'Class) is
      Stmt : ADO.Statements.Update_Statement := Session.Create_Statement (EMAIL_TABLE'Access);
   begin
   ...
   procedure Delete (Object  : in out Email_Impl;
                     Session : in out ADO.Sessions.Master_Session'Class) is
      Stmt : ADO.Statements.Delete_Statement := Session.Create_Statement (EMAIL_TABLE'Access);
   begin
   ...
   function Get_Value (Item : in Email_Ref;
      ...
      Impl : constant access Email_Impl := Email_Impl (Item.Get_Load_Object.all)'Access;
   begin
      if Name = "id" then
   ...
   procedure Set_First_Name (Object : in out User_Ref;
                              Value : in String) is
   begin
      Object.Set_First_Name (Ada.Strings.Unbounded.To_Unbounded_String (Value));
   end Set_First_Name;
   procedure Set_First_Name (Object : in out User_Ref;
                              Value  : in Ada.Strings.Unbounded.Unbounded_String) is
      Impl : User_Access;
   ...
   procedure Set_Last_Name (Object : in out User_Ref;
                             Value : in String) is
   begin
      Object.Set_Last_Name (Ada.Strings.Unbounded.To_Unbounded_String (Value));
   end Set_Last_Name;
   procedure Set_Last_Name (Object : in out User_Ref;
                             Value  : in Ada.Strings.Unbounded.Unbounded_String) is
      Impl : User_Access;
   ...
   procedure Set_Password (Object : in out User_Ref;
                            Value : in String) is
   begin
      Object.Set_Password (Ada.Strings.Unbounded.To_Unbounded_String (Value));
   end Set_Password;
   procedure Set_Password (Object : in out User_Ref;
                            Value  : in Ada.Strings.Unbounded.Unbounded_String) is
      Impl : User_Access;
   ...
   begin
      ...
      if Object.Is_Modified (4) then
         Stmt.Save_Field (Name  => COL_3_2_NAME, --  FIRST_NAME
                          Value => Object.First_Name);
         Object.Clear_Modified (4);
      end if;
      if Object.Is_Modified (5) then
         Stmt.Save_Field (Name  => COL_4_2_NAME, --  LAST_NAME
                          Value => Object.Last_Name);
         Object.Clear_Modified (5);
      end if;
      if Object.Is_Modified (6) then
         Stmt.Save_Field (Name  => COL_5_2_NAME, --  PASSWORD
                          Value => Object.Password);
         Object.Clear_Modified (6);
      end if;
      if Object.Is_Modified (7) then
         Stmt.Save_Field (Name  => COL_6_2_NAME, --  EMAIL_ID
                          Value => Object.Email);
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_2_2_NAME, --  NAME
                        Value => Object.Name);
      Query.Save_Field (Name  => COL_3_2_NAME, --  FIRST_NAME
                        Value => Object.First_Name);
      Query.Save_Field (Name  => COL_4_2_NAME, --  LAST_NAME
                        Value => Object.Last_Name);
      Query.Save_Field (Name  => COL_5_2_NAME, --  PASSWORD
                        Value => Object.Password);
      Query.Save_Field (Name  => COL_6_2_NAME, --  EMAIL_ID
                        Value => Object.Email);
      Query.Execute (Result);
      if Result /= 1 then
         raise ADO.Objects.INSERT_ERROR;
   ...
   begin
      ...
      Object.First_Name := Stmt.Get_Unbounded_String (3);
      Object.Last_Name := Stmt.Get_Unbounded_String (4);
      Object.Password := Stmt.Get_Unbounded_String (5);
   ...
   begin
      Object.Set_Field (Field);
      Impl := Access_Key_Impl (Object.Get_Object.all)'Access;
   end Set_Field;
   --  Internal method to allocate the Object_Record instance
   ...
   procedure Set_Access_Key (Object : in out Access_Key_Ref;
                              Value : in String) is
   begin
      Object.Set_Access_Key (Ada.Strings.Unbounded.To_Unbounded_String (Value));
   end Set_Access_Key;
   procedure Set_Access_Key (Object : in out Access_Key_Ref;
                              Value  : in Ada.Strings.Unbounded.Unbounded_String) is
      Impl : Access_Key_Access;
   ...
   procedure Save (Object  : in out Access_Key_Impl;
                   Session : in out ADO.Sessions.Master_Session'Class) is
      Stmt : ADO.Statements.Update_Statement := Session.Create_Statement (ACCESS_KEY_TABLE'Access);
   begin
      if Object.Is_Modified (1) then
   ...
   procedure Delete (Object  : in out Access_Key_Impl;
                     Session : in out ADO.Sessions.Master_Session'Class) is
      Stmt : ADO.Statements.Delete_Statement := Session.Create_Statement (ACCESS_KEY_TABLE'Access);
   begin
      Stmt.Set_Filter (Filter => "id = ?");
      Stmt.Add_Param (Value => Object.Get_Key);
      Stmt.Execute;
   ...
   function Get_Value (Item : in Access_Key_Ref;
                       Name : in String) return Util.Beans.Objects.Object is
      Impl : constant access Access_Key_Impl := Access_Key_Impl (Item.Get_Load_Object.all)'Access;
   begin
      if Name = "id" then
         return ADO.Objects.To_Object (Impl.Get_Key);
      end if;
   ...
   begin
      Object.Set_Field (Field);
      Impl := Session_Impl (Object.Get_Object.all)'Access;
   end Set_Field;
   --  Internal method to allocate the Object_Record instance
   ...
   procedure Set_Ip_Address (Object : in out Session_Ref;
                              Value : in String) is
   begin
      Object.Set_Ip_Address (Ada.Strings.Unbounded.To_Unbounded_String (Value));
   end Set_Ip_Address;
   procedure Set_Ip_Address (Object : in out Session_Ref;
                              Value  : in Ada.Strings.Unbounded.Unbounded_String) is
      Impl : Session_Access;
   ...
   procedure Save (Object  : in out Session_Impl;
                   Session : in out ADO.Sessions.Master_Session'Class) is
      Stmt : ADO.Statements.Update_Statement := Session.Create_Statement (SESSION_TABLE'Access);
   begin
      if Object.Is_Modified (1) then
   ...
   procedure Delete (Object  : in out Session_Impl;
                     Session : in out ADO.Sessions.Master_Session'Class) is
      Stmt : ADO.Statements.Delete_Statement := Session.Create_Statement (SESSION_TABLE'Access);
   begin
      Stmt.Set_Filter (Filter => "id = ?");
      Stmt.Add_Param (Value => Object.Get_Key);
      Stmt.Execute;
   ...
   function Get_Value (Item : in Session_Ref;
                       Name : in String) return Util.Beans.Objects.Object is
      Impl : constant access Session_Impl := Session_Impl (Item.Get_Load_Object.all)'Access;
   begin
      if Name = "id" then
         return ADO.Objects.To_Object (Impl.Get_Key);
      end if;
