-----------------------------------------------------------------------
--  AWA.Comments.model -- AWA.Comments.model
-----------------------------------------------------------------------
...
package AWA.Comments.model is
   ...
   procedure Set_User (Object : in out Comment_Ref;
                       Value  : in AWA.Users.Model.User_Ref'Class);

   --  Get 
   function Get_User (Object : in Comment_Ref)
                 return AWA.Users.Model.User_Ref'Class;
   ...
   --  
   --  --------------------
   type Comment_Info is tagged record
      --  identifier of the license plan.
      Id : ADO.Identifier;
      ...
      --  the promotion code associated with the license plan.
      Promotioncode : Ada.Strings.Unbounded.Unbounded_String;

      --  true if the license plan is free, false otherwise.
      Free : Boolean;

   end record;

   package Comment_Info_Vectors is
      new Ada.Containers.Vectors (Index_Type   => Natural,
                                  Element_Type => Comment_Info,
                                  "="          => "=");
   ...
   Commentlist : constant ADO.Queries.Query_Definition;
...
private
   ...
   procedure Set_Field (Object : in out Comment_Ref'Class;
                        ...
                        Field  : in Positive);
   Commentlist_NAME : aliased constant String := "commentList";

   Commentlist_REC : aliased ADO.Queries.Query_Definition_Record
      := ADO.Queries.Query_Definition_Record '(Name => Commentlist_NAME'Access);

   Commentlist : constant ADO.Queries.Query_Definition
      := Commentlist_REC'Access;

end AWA.Comments.model;
