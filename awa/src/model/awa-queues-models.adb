-----------------------------------------------------------------------
--  AWA.Queues.Models -- AWA.Queues.Models
-----------------------------------------------------------------------
...
package body AWA.Queues.Models is
   ...
   begin
      ...
      if Object.Is_Modified (4) then
         Stmt.Save_Field (Name  => COL_3_1_NAME, --  server_id
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_2_1_NAME, --  name
                        Value => Object.Name);
      Query.Save_Field (Name  => COL_3_1_NAME, --  server_id
                        Value => Object.Server_Id);
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_9_3_NAME, --  status
                        Value => Integer (Message_Status_Type'Pos (Object.Status)));
      Query.Save_Field (Name  => COL_10_3_NAME, --  type
                        Value => Object.Message_Type);
      Query.Save_Field (Name  => COL_11_3_NAME, --  user_id
                        Value => Object.User);
      Query.Save_Field (Name  => COL_12_3_NAME, --  session_id
                        Value => Object.Session);
