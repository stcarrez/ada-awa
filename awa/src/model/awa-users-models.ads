...
private
   ...
   COL_2_1_NAME : aliased constant String := "access_key";
   ...
   COL_2_2_NAME : aliased constant String := "email";
   ...
   COL_4_3_NAME : aliased constant String := "ip_address";
   COL_5_3_NAME : aliased constant String := "user_id";
   COL_6_3_NAME : aliased constant String := "type";
   COL_7_3_NAME : aliased constant String := "server_id";
   COL_8_3_NAME : aliased constant String := "auth_id";
   ...
   COL_2_4_NAME : aliased constant String := "openid";
   COL_3_4_NAME : aliased constant String := "name";
   COL_4_4_NAME : aliased constant String := "first_name";
   COL_5_4_NAME : aliased constant String := "last_name";
   COL_6_4_NAME : aliased constant String := "password";
   COL_7_4_NAME : aliased constant String := "country";
   COL_8_4_NAME : aliased constant String := "email_id";
