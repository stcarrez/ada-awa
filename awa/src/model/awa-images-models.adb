...
package body AWA.Images.Models is
   ...
   function Image_Data_Key (Id : in ADO.Identifier) return ADO.Objects.Object_Key is
   ...
   function Image_Data_Key (Id : in String) return ADO.Objects.Object_Key is
      Result : ADO.Objects.Object_Key (Of_Type  => ADO.Objects.KEY_STRING,
                                       Of_Class => IMAGE_DATA_TABLE'Access);
   begin
      ADO.Objects.Set_Value (Result, Id);
   ...
   function "=" (Left, Right : Image_Data_Ref'Class) return Boolean is
   begin
      return ADO.Objects.Object_Ref'Class (Left) = ADO.Objects.Object_Ref'Class (Right);
   end "=";

   procedure Set_Field (Object : in out Image_Data_Ref'Class;
                        Impl   : out Image_Data_Access) is
      Result : ADO.Objects.Object_Record_Access;
   begin
      Object.Prepare_Modify (Result);
      Impl := Image_Data_Impl (Result.all)'Access;
   end Set_Field;

   --  Internal method to allocate the Object_Record instance
   procedure Allocate (Object : in out Image_Data_Ref) is
      Impl : Image_Data_Access;
   begin
      Impl := new Image_Data_Impl;
      Impl.Version := 0;
   ...
   function Get_Id (Object : in Image_Data_Ref)
      ...
      Impl : constant Image_Data_Access := Image_Data_Impl (Object.Get_Object.all)'Access;
   begin
   ...
   function Get_Version (Object : in Image_Data_Ref)
                  return Integer is
      Impl : constant Image_Data_Access := Image_Data_Impl (Object.Get_Load_Object.all)'Access;
   begin
      return Impl.Version;
   end Get_Version;
   ...
   procedure Copy (Object : in Image_Data_Ref;
                   Into   : in out Image_Data_Ref) is
      Result : Image_Data_Ref;
   begin
      if not Object.Is_Null then
         declare
            Impl : constant Image_Data_Access
              := Image_Data_Impl (Object.Get_Load_Object.all)'Access;
            Copy : constant Image_Data_Access
              := new Image_Data_Impl;
         begin
   ...
   procedure Find (Object  : in out Image_Data_Ref;
      ...
      Impl  : constant Image_Data_Access := new Image_Data_Impl;
   begin
   ...
   --  Free the object
   --  --------------------
   procedure Destroy (Object : access Image_Data_Impl) is
      type Image_Data_Impl_Ptr is access all Image_Data_Impl;
      procedure Unchecked_Free is new Ada.Unchecked_Deallocation
              (Image_Data_Impl, Image_Data_Impl_Ptr);
      pragma Warnings (Off, "*redundant conversion*");
      Ptr : Image_Data_Impl_Ptr := Image_Data_Impl (Object.all)'Access;
   ...
   procedure Find (Object  : in out Image_Data_Impl;
      ...
      Stmt : ADO.Statements.Query_Statement
          := Session.Create_Statement (IMAGE_DATA_TABLE'Access);
   begin
   ...
   function Get_Value (Item : in Image_Data_Ref;
      ...
      Impl : access Image_Data_Impl;
   begin
      if Obj = null then
         return Util.Beans.Objects.Null_Object;
      end if;
      Impl := Image_Data_Impl (Obj.all)'Access;
      if Name = "id" then
   ...
   begin
      ...
      if Object.Is_Modified (5) then
         Stmt.Save_Field (Name  => COL_4_2_NAME, --  user_id
                          Value => Object.User);
         Object.Clear_Modified (5);
      end if;
      if Object.Is_Modified (6) then
         Stmt.Save_Field (Name  => COL_5_2_NAME, --  workspace_id
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_4_2_NAME, --  user_id
                        Value => Object.User);
   ...
   begin
      Set_Field (Object, Impl);
      Set_Field_Enum (Impl.all, 10, Impl.Storage, Value);
   end Set_Storage;
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 11, Impl.User, Value);
   end Set_User;
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 12, Impl.Folder, Value);
   end Set_Folder;
   ...
   procedure Set_Image (Object : in out Image_Ref;
                        Value  : in Image_Data_Ref'Class) is
      Impl : Image_Access;
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 13, Impl.Image, Value);
   end Set_Image;

   function Get_Image (Object : in Image_Ref)
                  return Image_Data_Ref'Class is
      Impl : constant Image_Access := Image_Impl (Object.Get_Load_Object.all)'Access;
   begin
      return Impl.Image;
   end Get_Image;
   ...
   begin
      ...
      if Object.Is_Modified (3) then
         Stmt.Save_Field (Name  => COL_2_3_NAME, --  width
                          Value => Object.Width);
         Object.Clear_Modified (3);
      end if;
      if Object.Is_Modified (4) then
         Stmt.Save_Field (Name  => COL_3_3_NAME, --  height
                          Value => Object.Height);
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_1_3_NAME, --  version
                        Value => Object.Version);
      Query.Save_Field (Name  => COL_2_3_NAME, --  width
                        Value => Object.Width);
      Query.Save_Field (Name  => COL_3_3_NAME, --  height
                        Value => Object.Height);
      ...
      Query.Save_Field (Name  => COL_6_3_NAME, --  mime_type
                        Value => Object.Mime_Type);
      Query.Save_Field (Name  => COL_7_3_NAME, --  path
                        Value => Object.Path);
      Query.Save_Field (Name  => COL_8_3_NAME, --  create_date
                        Value => Object.Create_Date);
      Query.Save_Field (Name  => COL_9_3_NAME, --  storage
                        Value => Integer (Storage_Type'Pos (Object.Storage)));
      Query.Save_Field (Name  => COL_10_3_NAME, --  user_id
                        Value => Object.User);
      Query.Save_Field (Name  => COL_11_3_NAME, --  folder_id
                        Value => Object.Folder);
      Query.Save_Field (Name  => COL_12_3_NAME, --  image_id
                        Value => Object.Image);
      Query.Execute (Result);
      if Result /= 1 then
         raise ADO.Objects.INSERT_ERROR;
   ...
   begin
      ...
      Object.Storage := Storage_Type'Val (Stmt.Get_Identifier (9));
      Object.Storage := Storage_Type'Val (Stmt.Get_Integer (9));
      if not Stmt.Is_Null (10) then
         Object.User.Set_Key_Value (Stmt.Get_Identifier (10), Session);
      end if;
      if not Stmt.Is_Null (11) then
         Object.Folder.Set_Key_Value (Stmt.Get_Identifier (11), Session);
      end if;
      if not Stmt.Is_Null (12) then
         Object.Image.Set_Key_Value (Stmt.Get_Identifier (12), Session);
      end if;
      Object.Version := Stmt.Get_Integer (1);
      ADO.Objects.Set_Created (Object);
   end Load;
