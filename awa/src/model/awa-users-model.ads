...
private
   ...
   Null_Email : constant Email_Ref := Email_Ref' (ADO.Objects.Object_Ref with others => <>);
   type Email_Impl is
   ...
   COL_3_2_NAME : aliased constant String := "FIRST_NAME";
   COL_4_2_NAME : aliased constant String := "LAST_NAME";
   COL_5_2_NAME : aliased constant String := "PASSWORD";
   COL_6_2_NAME : aliased constant String := "EMAIL_ID";
   USER_TABLE : aliased constant ADO.Schemas.Class_Mapping :=
     (Count => 7,
   ...
   Null_Access_Key : constant Access_Key_Ref := Access_Key_Ref' (ADO.Objects.Object_Ref with others => <>);
   ...
   Null_Session : constant Session_Ref := Session_Ref' (ADO.Objects.Object_Ref with others => <>);
