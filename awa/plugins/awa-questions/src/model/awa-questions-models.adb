...
package body AWA.Questions.Models is
   ...
   begin
      ...
      if Name = "short_description" then
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 7, Impl.Question, Value);
   end Set_Question;
   ...
   begin
      ...
      if Object.Is_Modified (7) then
         Stmt.Save_Field (Name  => COL_6_2_NAME, --  question_id
                          Value => Object.Question);
         Object.Clear_Modified (7);
      end if;
      if Object.Is_Modified (8) then
         Stmt.Save_Field (Name  => COL_7_2_NAME, --  author_id
                          Value => Object.Author);
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_5_2_NAME, --  version
                        Value => Object.Version);
      Query.Save_Field (Name  => COL_6_2_NAME, --  question_id
                        Value => Object.Question);
      Query.Save_Field (Name  => COL_7_2_NAME, --  author_id
                        Value => Object.Author);
      Query.Execute (Result);
      if Result /= 1 then
         raise ADO.Objects.INSERT_ERROR;
   ...
   begin
      ...
      if not Stmt.Is_Null (6) then
         Object.Question.Set_Key_Value (Stmt.Get_Identifier (6), Session);
      end if;
