...
package body AWA.Wikis.Models is
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 7, Impl.Wiki, Value);
   end Set_Wiki;
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 8, Impl.Content, Value);
   end Set_Content;
   ...
   begin
      ...
      if Object.Is_Modified (7) then
         Stmt.Save_Field (Name  => COL_6_2_NAME, --  wiki_id
                          Value => Object.Wiki);
         Object.Clear_Modified (7);
      end if;
      if Object.Is_Modified (8) then
         Stmt.Save_Field (Name  => COL_7_2_NAME, --  content_id
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_5_2_NAME, --  version
                        Value => Object.Version);
      Query.Save_Field (Name  => COL_6_2_NAME, --  wiki_id
                        Value => Object.Wiki);
      Query.Save_Field (Name  => COL_7_2_NAME, --  content_id
                        Value => Object.Content);
      Query.Execute (Result);
      if Result /= 1 then
         raise ADO.Objects.INSERT_ERROR;
   ...
   begin
      ...
      if not Stmt.Is_Null (6) then
         Object.Wiki.Set_Key_Value (Stmt.Get_Identifier (6), Session);
      end if;
      if not Stmt.Is_Null (7) then
         Object.Content.Set_Key_Value (Stmt.Get_Identifier (7), Session);
      end if;
