...
package body AWA.Workspaces.Models is
   ...
   procedure List (Object  : in out Workspace_Vector;
      ...
      Stmt : ADO.Statements.Query_Statement := Session.Create_Statement (Query, WORKSPACE_TABLE'Access);
   begin
      Stmt.Execute;
   ...
   procedure List (Object  : in out Member_Vector;
                   Session : in out ADO.Sessions.Session'Class;
                   Query   : in ADO.SQL.Query'Class) is
      Stmt : ADO.Statements.Query_Statement := Session.Create_Statement (Query, MEMBER_TABLE'Access);
   begin
      Stmt.Execute;
