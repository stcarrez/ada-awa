...
package body AWA.Votes.Models is
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Object (Impl.all, 3, Impl.User, Value);
   end Set_User;
   ...
   begin
      Set_Field (Object, Impl);
      ADO.Objects.Set_Field_Entity_Type (Impl.all, 4, Impl.For_Entity_Type, Value);
   ...
   begin
      ...
      Query.Set_Filter ("for_entity_id = ?");
      Impl.Find (Session, Query, Found);
      if not Found then
         Destroy (Impl);
   ...
   begin
      if Object.Is_Modified (1) then
         Stmt.Save_Field (Name  => COL_0_1_NAME, --  for_entity_id
      ...
      if Object.Is_Modified (3) then
         Stmt.Save_Field (Name  => COL_2_1_NAME, --  user_id
                          Value => Object.User);
         Object.Clear_Modified (3);
      end if;
      if Object.Is_Modified (4) then
         Stmt.Save_Field (Name  => COL_3_1_NAME, --  for_entity_type
                          Value => Object.For_Entity_Type);
         Object.Clear_Modified (4);
      end if;
      if Stmt.Has_Save_Fields then
         Stmt.Set_Filter (Filter => "for_entity_id = ?");
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_0_1_NAME, --  for_entity_id
                        Value => Object.Get_Key);
      Query.Save_Field (Name  => COL_1_1_NAME, --  rating
                        Value => Object.Rating);
      Query.Save_Field (Name  => COL_2_1_NAME, --  user_id
                        Value => Object.User);
      Query.Save_Field (Name  => COL_3_1_NAME, --  for_entity_type
                        Value => Object.For_Entity_Type);
   ...
   begin
      ...
      if not Stmt.Is_Null (2) then
         Object.User.Set_Key_Value (Stmt.Get_Identifier (2), Session);
      end if;
      Object.For_Entity_Type := ADO.Entity_Type (Stmt.Get_Integer (3));
      ADO.Objects.Set_Created (Object);
   end Load;
