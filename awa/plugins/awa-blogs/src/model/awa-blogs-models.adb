...
package body AWA.Blogs.Models is
   ...
   procedure Find (Object  : in out Blog_Impl;
      ...
      Stmt : ADO.Statements.Query_Statement
          := Session.Create_Statement (Query, BLOG_TABLE'Access);
   begin
      Stmt.Execute;
   ...
   procedure List (Object  : in out Blog_Vector;
      ...
      Stmt : ADO.Statements.Query_Statement := Session.Create_Statement (Query, BLOG_TABLE'Access);
   begin
      Stmt.Execute;
   ...
   procedure List (Object  : in out Post_Vector;
                   Session : in out ADO.Sessions.Session'Class;
                   Query   : in ADO.SQL.Query'Class) is
      Stmt : ADO.Statements.Query_Statement := Session.Create_Statement (Query, POST_TABLE'Access);
   begin
      Stmt.Execute;
